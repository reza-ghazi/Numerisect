...
> Analysis* (Version 0.8.0) [Computer software]. Zenodo.
> <https://doi.org/10.5281/zenodo.22882181>

## Which DOI should I use?

| Purpose | DOI |
|---|---|
| Cite the exact immutable `v0.8.0` source snapshot | [10.5281/zenodo.22882181](https://doi.org/10.5281/zenodo.22882181) |
...
`reza-ghazi/Numerisect-v0.8.0.zip`. The public record identifies it as software,
...
- [GitHub release `v0.8.0`](https://github.com/reza-ghazi/Numerisect/releases/tag/v0.8.0)
